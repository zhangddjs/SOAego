 ...
 */
function login() {
    return location.href = "http://localhost:8075/user/showLogin";
}
function regist() {
    return location.href = "http://localhost:8075/user/showRegister";
}
...
function search(a) {
    var b = "http://localhost:8074/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
