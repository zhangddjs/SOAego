...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://manager.ego.com:30080/web/itemcat/all?callback=category.getDataService",
		URL_Serv: "http://item.ego.com:30080/rest/itemcat/all?callback=category.getDataService",
		//URL_Serv: "http://www.ego.com:30080/category.json",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.ego.com:30080" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
