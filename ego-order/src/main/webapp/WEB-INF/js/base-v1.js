 ...
 */
function login() {
    return location.href = "http://passport.ego.com:30080/user/showLogin";
}
function regist() {
    return location.href = "http://passport.ego.com:30080/user/showRegister";
}
...
function search(a) {
    var b = "http://search.ego.com:30080/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
